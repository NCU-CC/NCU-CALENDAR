...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (networkInfo == null || !networkInfo.isConnected() || !networkInfo.isAvailable()) {
			...
			EventConfig EventConfig = new EventConfig("https://api.cc.ncu.edu.tw/calendar/v1/", getString(R.string.language));

			String[] scopeList = {"calendar.event.read","calendar.event.write","user.info.basic.read"};
